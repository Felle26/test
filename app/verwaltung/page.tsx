...
export default async function VerwaltungPage() {
  ...
  return <main className="mx-auto w-full max-w-[1920px] p-6"><AdministrationTabs employees={employees} roles={roles} schedules={schedules} screenSaverMinutes={displaySettings?.screenSaverMinutes ?? 5} weatherCity={displaySettings?.weatherCity ?? "Dresden"} /></main>;
}